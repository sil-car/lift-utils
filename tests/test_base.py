...
class TestAnnotation(unittest.TestCase):
    def test_annotation_good(self):
        ...
        for a in base.Annotation._props.get('attributes').get('required'):
            try:
...
class TestExtensible(unittest.TestCase):
    def test_extensible_good(self):
        ...
        for a in base.Extensible._props.get('attributes').get('required'):
            try:
...
class TestField(unittest.TestCase):
    def test_field_good(self):
        ...
        for a in base.Field._props.get('attributes').get('required'):
            try:
...
class TestForm(unittest.TestCase):
    def test_form_good(self):
        ...
        for a in base.Form._props.get('attributes').get('required'):
            try:
                self.assertIsNotNone(form.__dict__.get(a))
            except AssertionError as e:
                raise Exception(f"\"{a}\" {str(e)}")

        for elem in base.Form._props.get('elements').get('required'):
            try:
...
class TestGloss(unittest.TestCase):
    def test_gloss_good(self):
        ...
        for a in base.Gloss._props.get('attributes').get('required'):
            try:
...
class TestMultitext(unittest.TestCase):
    def test_multitext_good(self):
        ...
        for a in base.Multitext._props.get('attributes').get('required'):
            try:
...
class TestSpan(unittest.TestCase):
    def test_span_good(self):
        ...
        for a in base.Span._props.get('attributes').get('required'):
            try:
                self.assertIsNotNone(sp.__dict__.get(a))
            except AssertionError as e:
                raise Exception(f"\"{a}\" {str(e)}")

        for elem in base.Span._props.get('elements').get('required'):
            try:
...
class TestText(unittest.TestCase):
    def test_text_good(self):
        ...
        for a in base.Text._props.get('attributes').get('required'):
            try:
                self.assertIsNotNone(text.__dict__.get(a))
            except AssertionError as e:
                raise Exception(f"\"{a}\" {str(e)}")

        for elem in base.Text._props.get('elements').get('required'):
            try:
...
class TestTrait(unittest.TestCase):
    def test_trait_good(self):
        ...
        for a in base.Trait._props.get('attributes').get('required'):
            try:
...
class TestURLRef(unittest.TestCase):
    def test_urlref_good(self):
        ...
        for a in base.URLRef._props.get('attributes').get('required'):
            try:
